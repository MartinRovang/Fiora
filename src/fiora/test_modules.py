...
class OrientiationCheck:
    ...
    def tester(self, **kwargs) -> Union[bool, str]:
        ...
        if self.__class__.__name__ in suite:
            ...
            self.test_val = {"sagital_correlation": float(correlation_axis_0), "coronal_correlation": float(correlation_axis_1), "axial_correlation": float(correlation_axis_2)}
            if (correlation_axis_0 > correlation_axis_1) and (correlation_axis_0 > correlation_axis_2):
                return True
            else:
                return False
        else:
...
class DuplicateCheck:
    ...
    def tester(self, **kwargs) -> Union[bool, str]:
        ...
        if self.__class__.__name__ in suite:
            ...
            self.test_val = {key: False for key, value in ids_checks.items() if value == True}
